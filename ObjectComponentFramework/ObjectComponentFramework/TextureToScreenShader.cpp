...
bool TextureToScreenShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;
...
void TextureToScreenShader::Shutdown()
{
...
bool TextureToScreenShader::Render(ID3D11DeviceContext* deviceContext, RenderTarget& renderTarget)
{
	bool result;
	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, renderTarget);
	if(!result)
	{
		return false;
	}
...
void TextureToScreenShader::ShutdownShader()
{
...
void TextureToScreenShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
