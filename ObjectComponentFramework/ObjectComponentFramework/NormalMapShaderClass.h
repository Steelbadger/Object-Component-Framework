...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext* dc, rabd::ObjectID drawObject, World & world);
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext* dc, rabd::ObjectID drawObject, rabd::ObjectID cameraObject, World& world);
